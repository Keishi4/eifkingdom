...
if (n==1) printf("ДА"); else printf("НЕТ");
return n;
}
  ...
  if (nn!=6)
   {
    ...
    switch (nn)
     {
      case 1: printf(" с золотом: "); break;
      case 2: printf(" с землей: "); break;
      case 3: printf(" с зерном: "); break;
      case 4: printf(" с крестьянами: "); break;
      case 5: printf(" с гвардией: "); break;
     }
  ...
  if ((for_eat+for_posev)<=cur_zerno)
   {
    ...
    printf("\n\nВыделено зерна: на еду - %li тонн, на посев - %li тонн.",for_eat,for_posev);
...
clrscr();
fl_end=1;
if (fl_r==0) printf("Ваше правление завершилось...\n");
else
 {
